...
export interface Token {
    chainId: number; // 101,
    address: string; // 'Ey81135eJgk41DVifr3L4XucxqGzrQ4TpCw4yLhVSsW2',
    symbol: string; // 'STR',
    name: string; // 'Stream Token',
    decimals: number; // 9,
    logoURI: string; // 'https://imgur.com/yktZxQU',
    tags: string[]; // [ 'utility-token', 'governance-token' ]
}
